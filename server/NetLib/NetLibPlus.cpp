...
NETLIB_API std::shared_ptr<NetLibPlus_Client> NetLibPlus_getClient(int ServerID) //由于是shared_ptr，所以只要get出来就一定有效。只是可能用着一半连接断了，这无法避免。
{	
